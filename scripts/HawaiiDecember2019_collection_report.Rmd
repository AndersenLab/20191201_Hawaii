...
**Possible Solution:** Remove Gaotian's instance of C-0871 after extracting GPS location for other Kalopa collections.<br>
...
**3.** Collections with lat,long in Volcano need to be manually corrected to Kalopa. Gaotian and Clay will address.<br>
This should also resolve the duplicated collection_id (C-0871).<br>